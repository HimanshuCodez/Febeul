                ...
                >
                    <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4 border-b border-slate-100 pb-6">
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 w-full md:w-auto">
                            ...
                            <div className={`flex items-center justify-between sm:justify-start gap-2 rounded-xl px-3 py-2 border transition-colors ${(startDate || endDate) ? 'bg-pink-50 border-pink-200' : 'bg-white border-slate-200 hover:border-slate-300'}`}>
                                <CalendarRange size={15} className={`shrink-0 ${(startDate || endDate) ? 'text-pink-500' : 'text-slate-300'}`} />
                                <input
                                    type="date"
                                    value={startDate}
                                    max={endDate || undefined}
                                    onChange={(e) => setStartDate(e.target.value)}
                                    className="text-xs font-bold text-slate-600 focus:outline-none bg-transparent w-[92px] cursor-pointer min-w-0"
                                ...
                                {(startDate || endDate) && (
                                    <button
                                        ...
                                        className="text-pink-400 hover:text-rose-500 transition-colors shrink-0"
                                    >
                                        <X size={14} />
                                    </button>
                                )}
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="flex-1 sm:flex-none bg-gradient-to-r from-pink-500 to-rose-500 text-white py-2.5 px-4 rounded-xl font-bold text-sm shadow-lg shadow-pink-100 hover:shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2 shrink-0"
                                >
